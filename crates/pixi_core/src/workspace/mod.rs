...
/// synthesized from their contents rather than taken from the lock, which
/// stores rich platforms under short `p1`/`p2` aliases; `align_platform_names`
/// maps the rows back on by identity.
///
